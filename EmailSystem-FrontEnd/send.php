...
<html lang="en">
  ...
  <body>
  	...
  	<div class="container">
  		<div class="jumbotron">
  			<h1 class="display-4">Let's send a new template</h1>
  			<p class="lead">This is a restful api demo to get all email template and send from backend server by ajax and json</p>
  			<hr class="my-4">
			<div class="content">
